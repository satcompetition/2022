...
& \bf Solver & \bf Authors & \bf PAR-2 & \bf Solved & \\
\hline
1	 & ParKissat-RS & Xindi Zhang, Zhihan Chen, Shaowei Cai & 625.19 & 313 & \\
2	 & \emph{\color{gray}undisclosed} & \emph{\color{gray}undisclosed} & 827.64 & 278 & \\
2	 & \emph{\color{gray}undisclosed} & \emph{\color{gray}undisclosed} & 859.64 & 281 & \\
\end{tabularx}
\end{block}
}
